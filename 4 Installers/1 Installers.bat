...
# Download icon    
Get-FileFromWeb -URL "https://github.com/ManuelBiscotti/Windows/raw/refs/heads/main/Discord.ico" -File "$iconDir\Discord.ico"    
